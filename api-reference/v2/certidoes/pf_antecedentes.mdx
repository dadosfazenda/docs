---
title: "Polícia Federal - Antecedentes Criminais"
api: "POST /v2/certidoes/pf_antecedentes"
description: "Certidão de antecedentes criminais emitida pela Polícia Federal."
---
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`pf_antecedentes`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v2/certidoes/pf_antecedentes" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "pf_antecedentes",
    "data": { },
    "arquivos": [
      {
        "filename": "pf_antecedentes.pdf",
