---
title: "TSE - Quitação Eleitoral"
api: "POST /v2/certidoes/tse"
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`tse`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v2/certidoes/tse" \
