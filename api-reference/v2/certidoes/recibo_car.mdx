---
title: "Recibo do CAR"
api: "POST /v2/certidoes/recibo_car"
description: "Recibo oficial de inscrição do imóvel no Cadastro Ambiental Rural (CAR/SICAR), em PDF."
---

## Descrição

Recibo oficial de inscrição do imóvel no Cadastro Ambiental Rural (CAR/SICAR), em PDF.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`recibo_car`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v2/certidoes/recibo_car" \
