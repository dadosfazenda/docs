---
title: "Titularidade por CAR"
api: "POST /v2/certidoes/titularidade_car"
description: "Retorna a titularidade (proprietário) de um imóvel a partir do código CAR."
---

## Descrição

Retorna a titularidade (proprietário) de um imóvel a partir do código CAR.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`titularidade_car`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v2/certidoes/titularidade_car" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "titularidade_car",
    "data": { },
    "arquivos": [
      {
        "filename": "titularidade_car.pdf",
