---
title: "Lista Suja — Trabalho Escravo"
api: "POST /v1/certidoes/lista_suja_trabalho_escravo"
description: "Verifica se o CPF/CNPJ consta no Cadastro de Empregadores (Lista Suja do Trabalho Escravo)."
---

## Descrição

Verifica se o CPF/CNPJ consta no Cadastro de Empregadores (Lista Suja do Trabalho Escravo).
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`lista_suja_trabalho_escravo`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/lista_suja_trabalho_escravo" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "lista_suja_trabalho_escravo",
    "data": { },
    "arquivos": [
      {
        "filename": "lista_suja_trabalho_escravo.pdf",
