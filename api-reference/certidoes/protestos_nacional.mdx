---
title: "Protestos Nacional — IEPTB"
api: "POST /v1/certidoes/protestos_nacional"
description: "Consulta nacional de protestos de títulos em cartórios, homologada pelo CENPROT/IEPTB, por CPF ou CNPJ."
---

## Descrição

Consulta nacional de protestos de títulos em cartórios, homologada pelo CENPROT/IEPTB, por CPF ou CNPJ.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`protestos_nacional`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/protestos_nacional" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "protestos_nacional",
    "data": { },
    "arquivos": [
      {
        "filename": "protestos_nacional.pdf",
