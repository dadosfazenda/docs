---
title: "IBAMA — Certidão Negativa de Embargos"
api: "POST /v1/certidoes/ibama_embargos"
description: "Certidão de áreas embargadas no IBAMA."
---

## Descrição

Certidão de áreas embargadas no IBAMA.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`ibama_embargos`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/ibama_embargos" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "ibama_embargos",
    "data": { },
    "arquivos": [
      {
        "filename": "ibama_embargos.pdf",
