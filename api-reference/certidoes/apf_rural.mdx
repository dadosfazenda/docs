---
title: "APF Rural"
api: "POST /v1/certidoes/apf_rural"
...
<ParamField body="cnpj_or_cpf" type="string" required>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/apf_rural" \
  -H "Authorization: Bearer SEU_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "cnpj_or_cpf": "12345678000190"
  }'
```
