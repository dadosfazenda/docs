---
title: "MPF — Certidão Negativa"
api: "POST /v1/certidoes/mpf"
description: "Certidão negativa no Ministério Público Federal."
---

## Descrição

Certidão negativa no Ministério Público Federal.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`mpf`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/mpf" \
