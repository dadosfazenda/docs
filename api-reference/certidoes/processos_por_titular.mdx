---
title: "Processos Judiciais por Titular"
api: "POST /v1/certidoes/processos_por_titular"
description: "Lista processos judiciais vinculados a um CPF/CNPJ."
---

## Descrição

Lista processos judiciais vinculados a um CPF/CNPJ.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`processos_por_titular`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/processos_por_titular" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "processos_por_titular",
    "data": { },
    "arquivos": [
      {
        "filename": "processos_por_titular.pdf",
