---
title: "Imóveis Rurais por Titular"
api: "POST /v1/certidoes/imoveis_por_titular"
description: "Lista os imóveis rurais (CARs) vinculados a um CPF/CNPJ."
---

## Descrição

Lista os imóveis rurais (CARs) vinculados a um CPF/CNPJ.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`imoveis_por_titular`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/imoveis_por_titular" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "imoveis_por_titular",
    "data": { },
    "arquivos": [
      {
        "filename": "imoveis_por_titular.pdf",
