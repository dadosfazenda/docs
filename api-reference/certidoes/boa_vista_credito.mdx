...
api: "POST /v1/certidoes/boa_vista_credito"
description: "Relatório de crédito por CPF/CNPJ: score, situação cadastral e histórico de consultas."
---

## Descrição

Relatório de crédito por CPF/CNPJ: score, situação cadastral e histórico de consultas.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`boa_vista_credito`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/boa_vista_credito" \
...
```json 200 OK
{
  ...
  "message": "Success",
  "data": {
    "certidao": "boa_vista_credito",
    "data": { },
    "arquivos": [
      {
        "filename": "boa_vista_credito.pdf",
