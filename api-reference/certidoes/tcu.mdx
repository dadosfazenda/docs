---
title: "TCU — Certidão Negativa de Processo"
api: "POST /v1/certidoes/tcu"
description: "Certidão negativa de processos no Tribunal de Contas da União."
---

## Descrição

Certidão negativa de processos no Tribunal de Contas da União.
...
<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`tcu`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/tcu" \
