---
title: "TRT — Certidão Trabalhista"
api: "POST /v1/certidoes/trt"
description: "Certidão no Tribunal Regional do Trabalho da região informada."
---

## Descrição

Certidão no Tribunal Regional do Trabalho da região informada.
...
<ParamField body="regiao_trt" type="string" required>
  Número da região do TRT (1 a 24).
</ParamField>

## Resposta

<ResponseField name="certidao" type="string">
  Identificador da certidão consultada (`trt`).
</ResponseField>
...
```bash cURL
curl -X POST "https://data.dadosfazenda.com.br/v1/certidoes/trt" \
